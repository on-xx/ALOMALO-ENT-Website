...
const ArtistProfileGallery = ({ selectedArtist }) => {
  const currentArtist = artistData.find(
            ...
            <div className="artist-detail flex-column">
              ...
              <div className="artist-detail-row flex-row">
                <div className="artist-detail-col-1 flex-column">
                  ...
                  {currentArtist.profile && currentArtist.profile.length > 0 && (
                    <>
                      <h3>프로필</h3>
                      {currentArtist.profile.map((profile, index) => (
                ...
                <div className="artist-detail-col-2 flex-column">
                  ...
                  {currentArtist.tvshows &&
                    currentArtist.tvshows.length > 0 && (
                      <>
                        <h3>TV 프로그램</h3>
                  ...
                  {currentArtist.musicals &&
                    currentArtist.musicals.length > 0 && (
                      <>
                        <h3>뮤지컬</h3>
                  ...
                  {currentArtist.careers &&
                    currentArtist.careers.length > 0 && (
                      <>
                        <h3>기타</h3>
